...
func getJsonStringToBuildBackups() string {
	//cha := `[{"archive":[{"database":{"id":1,"repo-key":2},"id":"13-1","max":"000000240000020B00000045","min":"00000022000001C4000000CA"}],"backup":[{"archive":{"start":"00000022000001C4000000CA","stop":"00000022000001C4000000DB"},"backrest":{"format":5,"version":"2.36"},"database":{"id":1,"repo-key":2},"error":false,"info":{"delta":91597556633,"repository":{"delta":24107897451,"size":24107897451},"size":91597556633},"label":"20230328-000720F","prior":null,"reference":null,"timestamp":{"start":1679962040,"stop":1679967029},"type":"full"}]}]`
